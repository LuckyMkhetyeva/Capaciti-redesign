...
function populatePartners() { 
    ...
    const partners = [ 
        ...
        { name: "MEDIA24", logo: "media24.png" }, 

        { name: "Younglings", logo: "younglings.jfif" }, 

        { name: "Microsoft", logo: "microsoft.png" }, 

        { name: "Allan Gray Orbis Foundation", logo: "llan-gray.png" }, 

        { name: "YES4YOUTH", logo: "yes4youth.png" }, 

        { name: "Investec", logo: "investec.png" } 
    ...
    container.innerHTML = partners.map(partner => ` 
        ...
        <div class="col-6 col-md-4 col-lg-2"> 
            ...
            <div class="bg-light rounded p-3 text-center partner-logo-container"> 

                <img src="${partner.logo}" alt="${partner.name} logo" class="partner-logo img-fluid" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-block';" /> 

                <span class="text-muted fw-semibold fallback-text" style="display:none;">${partner.name}</span> 
